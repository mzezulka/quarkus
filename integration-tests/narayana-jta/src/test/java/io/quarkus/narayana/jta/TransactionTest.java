...
public class TransactionTest {
    ...
    public static void setup() {
        AbstractPropertiesFactory mockFactory = Mockito.mock(AbstractPropertiesFactory.class);
        Mockito.when(mockFactory.getDefaultProperties())
                .thenThrow(new IllegalStateException("XML parsing invocation done at runtime!"));
        PropertiesFactory.setDelegatePropertiesFactory(mockFactory);
    }
